...
async function extractor(options: ExtractBuilderSchema, context: TargetContext) {
...
export default async function runExecutor(options: ExtractBuilderSchema, context: TargetContext){
